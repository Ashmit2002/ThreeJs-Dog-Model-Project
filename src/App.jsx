      ...
      <main>
        ...
        <section id="section-4">
          <div className="bottom">
            <div className="left"></div>
            <div className="right">
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque dicta dolorem alias in, cum sint maxime autem voluptatum sit laboriosam, mollitia commodi fuga soluta magnam necessitatibus esse natus temporibus architecto reiciendis maiores. Enim, nesciunt. Tempora reprehenderit temporibus, similique mollitia sit assumenda totam quod. A, odit esse natus id eum debitis.</p>
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque dicta dolorem alias in, cum sint maxime autem voluptatum sit laboriosam, mollitia commodi fuga soluta magnam necessitatibus esse natus temporibus architecto reiciendis maiores. Enim, nesciunt. Tempora reprehenderit temporibus, similique mollitia sit assumenda totam quod. A, odit esse natus id eum debitis.</p>
            </div>
          </div>
        </section>
